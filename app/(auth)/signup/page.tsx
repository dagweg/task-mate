            ...
            <div>
                <div className='relative mx-auto min-w-[500px] w-fit h-fit min-h-[300px] border-[1px] shadow-md rounded-md  bg-white bg-opacity-50 backdrop-blur-lg  group/main'>
                    ...
                    <div className='relative bg-white inset-0 h-full flex flex-col md:flex-row items-center justify-center gap-10 px-24 py-10 rounded-md z-[10]'>
                        ...
                        <form onSubmit={handleSubmit} className='relative flex flex-col gap-4  w-full'>
                            <div className='grid gap-4'>
                                <div className='flex flex-col'>
                                    <TextBox placeholder='First Name' className='!rounded-lg !border-0 focus:!bg-opacity-80 outline-gray-400 outline-offset-[-2px] focus:!outline-gray-800 !h-10' onChange={(e: any) => handleInputChange(e, 'firstName')} />
                                </div>
                                <div className='flex flex-col'>
                                    <TextBox placeholder='Last Name' className='!rounded-lg !border-0 focus:!bg-opacity-80 outline-gray-400 outline-offset-[-2px] focus:!outline-gray-800 !h-10' onChange={(e: any) => handleInputChange(e, 'lastName')} />
                                </div>
                            </div>
                            <div className='grid lg:grid-cols-2 gap-4'>
                                <div className='flex flex-col'>
                                    <TextBox placeholder='Email' className='!rounded-lg !border-0 focus:!bg-opacity-80 outline-gray-400 outline-offset-[-2px] focus:!outline-gray-800 !h-10' onChange={(e: any) => handleInputChange(e, 'email')} />
                                </div>
                                <div className='flex flex-col'>
                                    <TextBox placeholder='Password' className='!rounded-lg !border-0 focus:!bg-opacity-80 outline-gray-400 outline-offset-[-2px] focus:!outline-gray-800 !h-10' onChange={(e: any) => handleInputChange(e, 'passWord')} type='password' />
                                </div>
                                <div className='flex flex-col'>
                                    <TextBox placeholder='Confirm Password' className='!rounded-lg !border-0 focus:!bg-opacity-80 outline-gray-400 outline-offset-[-2px] focus:!outline-gray-800 !h-10' onChange={(e: any) => handleInputChange(e, 'confirmPassWord')} type='password' />
                                </div>
                            </div>
                            <div className='flex flex-col'>
                                <div className='flex w-fit bg-red-100'>
                                    ...
                                    <TextBox placeholder='Phonenumber' className='!h-10 max-w-2xl !flex-grow !rounded-md' onChange={(e: any) => handleInputChange(e, 'phoneNumber')} />
                                </div>
                            </div>

                            <input type='submit' value={'Create Account'} className={cn('bg-slate-500  cursor-pointer text-white py-3 hover:bg-slate-900 duration-75 transition w-full font-semibold !rounded-lg my-2 max-w-[300px]')}></input>
                ...
                <Dialog.Root>
                    ...
                    <DialogContent style={{ maxWidth: 450 }} className='flex flex-col justify-center items-center '>
