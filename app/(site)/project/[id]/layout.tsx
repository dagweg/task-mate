...
function ProjectLayout({ children }: { children: ReactNode }) {
    ...
    return (
        ...
        //         <Link href={`/project/AddTasks?pid=${projectdId}`}> <p className='bg-gray-200 rounded-t-lg p-2 text-sm hover:bg-gray-100 duration-150 cursor-pointer'>Add Task</p></Link>
        //         <Link href={`/project/ViewTasks?pid=${projectdId}`}><p className='bg-gray-200 rounded-t-lg p-2 text-sm hover:bg-gray-100 duration-150 cursor-pointer'>View Tasks</p></Link>
