            ...
            <div className='bg-white w-full h-screen relative rounded-2xl shadow-lg p-10 mx-auto grid grid-cols-2 gap-20 px-52'>
                <div className='flex flex-col gap-4'>
                    <div className='text-field flex flex-col'>
                        ...
                        <input type="text" name="" id="" className='outline-none border border-black  p-3 border-b-2 border-[#2226] rounded-sm focus:border-indigo-500 w-[100%]' />
                    </div>
                    <div className='text-field flex flex-col'>
                ...
                <div className='flex justify-end items-center'>
                    <div className='h-16 w-[80%] hover:rounded-full flex justify-center items-center text-xl text-black  outline outline-indigo-500 outline-2 hover:bg-indigo-500 hover:text-white hover:font-black cursor-pointer duration-150 ease-in active:scale-95'>
                        Finish
                    </div>
                </div>
            </div>
