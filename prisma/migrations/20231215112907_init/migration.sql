-- CreateEnum
CREATE TYPE "Role" AS ENUM ('TEAM_MANAGER', 'TEAM_MEMBER');
...
CREATE TABLE "Stakeholder" (
    ...
    CONSTRAINT "Stakeholder_pkey" PRIMARY KEY ("email")
);
...
-- CreateIndex
CREATE INDEX "Project_title_dueDate_idx" ON "Project"("title", "dueDate");
...
-- AddForeignKey
ALTER TABLE "Stakeholder" ADD CONSTRAINT "Stakeholder_email_fkey" FOREIGN KEY ("email") REFERENCES "Project"("id") ON DELETE CASCADE ON UPDATE CASCADE;
